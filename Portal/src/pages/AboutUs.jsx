                    ...
                    <div className={`col-sm-6 col-lg-3 ${AboutUsCSS.teamCards}`}>
                        <div className={AboutUsCSS.team}>
                            ...
                            <div className={`${AboutUsCSS.face} ${AboutUsCSS.backFace}`}>
                                ...
                                Excels in management, ensuring smooth project execution through task division. A Full Stack development enthusiast, he combines leadership with technical expertise.
