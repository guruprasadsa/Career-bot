...
def GenerateResponse(input_text):
    ...
    "you are a career counselling chatbot that can suggest courses to persue and also can provide top colleges, so reply accordingly and let replies be short and concisealways provide counselling with respect to india only",
